      ...
      <div className="container mx-auto px-4 py-24 mt-16">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-gray-600 text-lg mb-8">
            Have questions about our tours? We'd love to hear from you. Fill out the form below and we'll get back to you as soon as possible.
          </p>

          {submitted && (
            <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
              <p className="text-green-700 font-semibold">✓ Thank you! Your message has been sent successfully.</p>
              <p className="text-green-600 text-sm mt-1">We'll contact you shortly.</p>
            </div>
          )}
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">info@xinjiangtrave.com</p>
            </div>
            <div className="text-center p-6 bg-gray-50 rounded-lg">
              <div className="text-3xl mb-2">📱</div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">Urumqi, Xinjiang, China</p>
            </div>
          </div>
        </div>
      </div>
