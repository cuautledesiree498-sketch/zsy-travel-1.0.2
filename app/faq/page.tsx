...
const faqs = [
  ...
  { q: { en: 'What do you confirm before payment?', zh: '付款前会先确认什么？' }, a: { en: 'We normally confirm the route direction, travel dates, traveler structure, service scope, and what this payment is actually for. Getting those points clear first is much safer than asking you to pay upfront without context.', zh: '通常会先确认路线方向、出行日期、人数结构、服务范围，以及这次付款对应的内容是什么。先把这些说清楚，再谈付款，会比一上来就付款更稳。' } },
